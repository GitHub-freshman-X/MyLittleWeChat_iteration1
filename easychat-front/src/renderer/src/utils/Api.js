const api = {
    ...
    getGroupInfo4Chat: "/group/getGroupInfo4Chat", // 获取群聊群详情信息
    ...
    loadAdminAccount: "/admin/loadUser", // 后台管理员账户列表
    updateUserStatus: "/admin/updateUserStatus", // 后台更新封禁用户表
    ...
    loadBeautyAccount: "/admin/loadBeautyAccountList", // 账号列表
